(function($) {
 ...
 var dzChartlist = function(){
	...
	var widgetChart1 = function(){
		...
		var data = document.querySelector("#widgetChart1");
		if(data != undefined){
			var chartBar1 = new ApexCharts(data, options);
			chartBar1.render();
		}
	...
	var widgetChart2 = function(){
		...
		var data = document.querySelector("#widgetChart2");
		if(data != undefined){
		var chartBar1 = new ApexCharts(data, options);
		chartBar1.render();
		}
	...
	var donutChart2 = function(){
		...
		var data = document.querySelector("#donutChart2");
		if(data != undefined){
       	 	var chart = new ApexCharts(data, options);
        	chart.render();
		}
	}
	var donutChart3 = function(){
		...
		var data = document.querySelector("#donutChart3");
		if(data != undefined){
	...
	var donutChart4 = function(){
		...
		var data = document.querySelector("#donutChart4");
		if(data != undefined){
	...
	var salesChart = function(){
		...
		var data = document.querySelector("#salesChart");
		if(data != undefined){
	...
	var salesChart1 = function(){
		...
		var data = document.querySelector("#salesChart1");
		if(data != undefined){
	...
	var salesChart2 = function(){
		...
		var data = document.querySelector("#salesChart2");
		if(data != undefined){
		var chartBar1 = new ApexCharts(data, options);
		chartBar1.render();
		}
